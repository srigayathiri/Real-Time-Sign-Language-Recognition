...
classifier = Classifier("C:\\Users\\hp\\OneDrive\\Desktop\\Project\\ModelWord\\keras_model.h5","C:\\Users\\hp\\OneDrive\\Desktop\\Project\\ModelWord\\labels.txt")
labels = ["callme","first","livelong","okay","peace","rock","smile","stop","thumbsdown","thumbsup"]


# Create a tkinter GUI window
window = tk.Tk()
window.title("சைகை மொழியிலிருந்து உரையை மாற்றுதல்")
...
T1 = tk.Label(window)
T1.place(x=10, y=580)
T1.config(text="சொல் :", font=("Helvetica", 25, "bold"),bg="#f04848")


l1 = tk.Label(window)
l1.place(x=10, y=690)
l1.config(text="வாக்கியம் :", font=("Helvetica", 25, "bold"),bg="#f04848")
...
buttonClear = tk.Button(window,text ="அகற்று",command=remove)
...
T = tk.Label(window)
T.place(x=400, y=10)
T.config(text="சைகை மொழியிலிருந்து உரையை மாற்றுதல்", font=("Helvetica", 25, "bold"),bg="#f04848")
...
def update():
    ...
    if hands:
        ...
        if prediction[index] >= 0.98:
            ...
            op = Tamil.translate_to_tamil(labels[index])

            l.config(text=op, font=("Helvetica", 25, "bold"))
            l['background']='#f04848'
            ...
            buttonAdd = tk.Button(window,text ="கூட்டு",command=sentence)
            ...
            buttonVoice = tk.Button(window,text ="குரல்",command=voice)
            buttonVoice.place(x=1330,y=630)
            buttonVoice.config(
                font=("Helvetica", 15,"bold"),  # Set the font
                fg="black",  # Set the text color  # Set the background color
                relief="solid",  # Set the border style
            ...
            #cv2.putText(imgOutput,op,(x,y-20),cv2.FONT_HERSHEY_COMPLEX,2,(255,0,255),2)
